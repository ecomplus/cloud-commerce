...
var restFunctions = {
    create: function create(data, config, cb) {
        api.executeHttp(this.defaultOptions, 'POST', this.baseURL, data, config, cb);
    },
    get: function get(id, config, cb) {
        api.executeHttp(this.defaultOptions, 'GET', this.baseURL + id, {}, config, cb);
    },
    list: function list(data, config, cb) {
        ...
        api.executeHttp(this.defaultOptions, 'GET', this.baseURL, data, config, cb);
    },
    del: function del(id, config, cb) {
        api.executeHttp(this.defaultOptions, 'DELETE', this.baseURL + id, {}, config, cb);
    },
    ...
    capture: function capture(id, data, config, cb) {
        api.executeHttp(this.defaultOptions, 'POST', this.baseURL + id + '/capture', data, config, cb);
    },
    refund: function refund(id, data, config, cb) {
        api.executeHttp(this.defaultOptions, 'POST', this.baseURL + id + '/refund', data, config, cb);
    },
    update: function update(id, data, config, cb) {
        api.executeHttp(this.defaultOptions, 'PATCH', this.baseURL + id, data, config, cb);
    },
    cancel: function cancel(id, data, config, cb) {
        api.executeHttp(this.defaultOptions, 'POST', this.baseURL + id + '/cancel', data, config, cb);
    }
};

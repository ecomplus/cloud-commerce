 ...
 */
function billingAgreement(defaultOptions) {
    ...
    function searchTransactions(id, start_date, end_date, config, cb) {
        ...
        api.executeHttp(defaultOptions, 'GET', baseURL + id + '/transactions', date_range, config, cb);
    }
    ...
    function billBalance(id, data, config, cb) {
        api.executeHttp(defaultOptions, 'POST', baseURL + id + '/bill-balance', data, config, cb);
    }
    ...
    function setBalance(id, data, config, cb) {
        api.executeHttp(defaultOptions, 'POST', baseURL + id + '/set-balance', data, config, cb);
    }
    ...
    var ret = {
        ...
        execute: function execute(token, data, config, cb) {
            ...
            api.executeHttp(defaultOptions, 'POST', this.baseURL + token + '/agreement-execute', data, config, cb);
        },
        /**
        ...
        suspend: function suspend(id, data, config, cb) {
            api.executeHttp(defaultOptions, 'POST', this.baseURL + id + '/suspend', data, config, cb);
        },
        /**
        ...
        reactivate: function reactivate(id, data, config, cb) {
            api.executeHttp(defaultOptions, 'POST', this.baseURL + id + '/re-activate', data, config, cb);
        },

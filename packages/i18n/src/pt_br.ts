...
export const i19allProducts = 'Todos os produtos'
...
export const i19anyPrice = 'Qualquer preço'
...
export const i19buyOnWhatsApp = 'Comprar pelo WhatsApp'
...
export const i19browseCategoriesToSearchMsg = 'Navegue pelas categorias para encontrar seu produto ou semelhante.'
...
export const i19checkSearchWordMsg = 'Revise a ortografia da palavra.'
export const i19chooseProductDetailsToBuy = 'Escolha os detalhes do produto para comprar'
...
export const i19discounts = 'Descontos'
...
export const i19filterOut = 'Filtrar'
...
export const i19get = 'Receba'
export const i19get$1back = 'Receba $1 de volta'
...
export const i19institutional = 'Institucional'
...
export const i19loadMoreProducts = 'Carregar mais produtos'
...
export const i19loadToCartErrorMsg = 'Não foi possível adicionar ao carrinho, algum item está indisponível.'
...
export const i19noItemSelected = 'Nenhum item selecionado'
...
export const i19noProductsInBrandMsg = 'Não há nenhum produto dessa marca.'
export const i19noProductsInCategoryMsg = 'Não há nenhum produto nessa categoria.'
export const i19noProductsFound = 'Nenhum produto encontrado'
export const i19noProductsFoundFor$1 = 'Nenhum produto encontrado para $1'
...
export const i19relatedProducts = 'Produtos relacionados'
...
export const i19reviews = 'Avaliações'
export const i19safeBuy = 'Compra segura'
...
export const i19sendLoginLinkByEmail = 'Enviar link de acesso por e-mail'
...
export const i19someItemIsUnavailable = 'Algum item está indisponível'
...
export const i19toggleMenu = 'Abrir/fechar menu'
...
export const i19uponRequest = 'Son consulta'
...
export const i19useGenericSearchWordsMsg = 'Use palavras mais genéricas ou menos palavras.'
